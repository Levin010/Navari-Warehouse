...
function populateTableWithMovingAverage(data) {
    ...
    tbody.append('<tr><td colspan="8" style="text-align: center; padding: 20px; color: #666;">Calculating moving average valuations...</td></tr>');
...
function processEntriesSequentially(data, index) {
    ...
    calculateMovingAverage(entry.product, entry.name)
        ...
        .catch(function(error) {
            console.error('Error calculating moving average for entry:', entry, error);
